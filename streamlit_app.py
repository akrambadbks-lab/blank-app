...
# ==========================================
    ...
    if uploaded_files and st.button("Fusionner les fichiers 🚀"):
        with st.spinner("Analyse et fusion..."):
            ...
            mandatory_columns = ['Phone Number', 'Address'] #------mandatory kat bda henna bedel HNA !!!!!!!!!!!!!!!!!----
...
# ==========================================
# 5. APPLICATION : FILTRE DÉPARTEMENTS FRANCE
# ==========================================
            ...
            if col_cp.lower() not in cols_lower:
                ...
                with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zip_file:
                    ...
                    if not df_liste1.empty:
                        ...
                        zip_file.writestr(f"{nom_base}_ABC.{ext}", file_buffer1.getvalue())
                    ...
                    if not df_liste2.empty:
                        ...
                        zip_file.writestr(f"{nom_base}_IDF.{ext}", file_buffer2.getvalue())
                
                st.success("✅ Traitement terminé !")
                st.info(f"📁 Fichier ABC (07, 26, 42, 38, 69, 73, 74) : {len(df_liste1)} contacts.")
                st.info(f"📁 Fichier IDF (91, 92, 93, 94, 95, 77, 78) : {len(df_liste2)} contacts.")
                    ...
                    if phone_col in df.columns:
                        def clean_phone(phone):
                            ...
                            if country == 'France':
                                ...
                                if len(digits) == 11 and not digits.startswith('33'): digits = '33' + digits[2:]
                            return digits
